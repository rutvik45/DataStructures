...
cout<<"\n--------------------------------\n";
cout<<"\nSubtraction Hashing Technique with Linear Probe\n";
cout<<"\n--------------------------------\n";
while(1) {
...
switch(c) {
case 1:
cout<<"Enter element to be inserted: \n Enter the number in the range 1000-1100\n";
cin>>v;
k=v-1000;
cout<<"\nGenerated Key: "<<k<<"\n";
hash.Insert(k, v);
...
cin>>k;
if(hash.SearchKey(k-1000) == -1) {
cout<<"No element found"<<endl;
continue;
} else {
cout<<"Element at key "<<k-1000<<" : ";
cout<<hash.SearchKey(k-1000)<<endl;
}
break;
case 3:
