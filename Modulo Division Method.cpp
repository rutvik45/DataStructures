...
HashMapTable hash;
int k, v;
int c, count=0,flag,size;
cout<<"\n--------------------------------\n";
cout<<"ASHVIN SHETTY - FY-MCA-B-104 \n";
cout<<"\n--------------------------------\n";
cout<<"\nModulo Division Hashing Technique with Linear Probe\n";
cout<<"\n--------------------------------\n";
while(1) {
...
cin>>k;
if(hash.SearchKey(v%size) == -1) {
cout<<"No element found"<<endl;
continue;
} else {
cout<<"Element at key "<<v%size<<" : ";
cout<<hash.SearchKey(v%size)<<endl;
}
break;
case 3:
